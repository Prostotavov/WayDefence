...
protocol AchieveTableViewDelegate: AnyObject {
    func getButtonPressed(rewards: BattleReward)
}

class AchieveTableView: UIView, UITableViewDataSource, UITableViewDelegate {

    weak var delegate: AchieveTableViewDelegate!
...
extension AchieveTableView: QuestCellDelegate {
